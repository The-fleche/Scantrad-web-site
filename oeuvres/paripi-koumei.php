...
<head>
    ...
    <title><?php echo $nom ?> Description</title>
</head>
...
<body>
    ...
    $query = "SELECT * FROM oeuvre WHERE nom='$nom'";

    $results = mysqli_query($mysqli, $query);
    $res = mysqli_fetch_assoc($results);

    $dateQuery = "SELECT * FROM chapitres JOIN oeuvre ON oeuvre.id=chapitres.idOeuvre WHERE oeuvre.nom='$nom' ORDER BY numChap DESC";
    ...
    <section class="main">
        ...
        <div class="contain">
            <div class="artwork">
                ...
                <div class="banner">
                    <img src="../images/banners/<?php echo($nom); ?> banner.jpg"
                        alt="<?php echo($nom); ?> Banner">
                </div> <!--.banner-->
                <div class="image">
                ...
                <div class="artwork-infos">
                    <div class="public">
                        ...
                        <div class="status">Status: <?php echo($res['status']); ?></div> <!--.status-->

                    </div> <!--.public-->

                    <div class="info">
                        <div class="title"><u><?php echo($nom);?></u></div> <!--.title-->
                        <div class="synopsis">
                        ...
                        <div class="infos">
                            ...
                            <div class="artist"><u>Artiste</u>
                                <p><?php echo ($res['artiste']); ?></p>
                            </div>
                            <div class="last-update"><u>Dernière sortie</u>
                                <p><?php echo(date('d/m/Y', strtotime($resDate['dateSortie']))); ?></p>
                            </div>
                        ...
                        <div class="genres">
                            ...
                            <?php
                                ...
                                $queryGenre = "SELECT * FROM genres JOIN oeuvre ON oeuvre.id=genres.idOeuvre WHERE nom='$nom' ORDER BY value ASC";
            ...
            <div class="chapters">
                <div class="title"><?php echo($res['nom']); ?></div> <!--.title-->
                <div class="chapter-container">
                    ...
                    <div class="chap-buttons">
                        <div class="first-chap">
                            ...
                            <?php
                                $queryFirstChapter = "SELECT numChap FROM chapitres JOIN oeuvre ON oeuvre.id=chapitres.idOeuvre WHERE nom='$nom' ORDER BY numChap ASC LIMIT 1";
                                $resFirstChap = mysqli_query($mysqli, $queryFirstChapter);
                                $resultFirstChap = mysqli_fetch_assoc($resFirstChap);
                            ?>
                            <h2>Chapitre <?php echo( $resultFirstChap['numChap']); ?></h2>
                        </div> <!--.first-chap-->
                        <div class="last-chap">
                            <h3>Dernier chapitre</h3>

                            <?php 
                                $queryLastChapter = "SELECT numChap FROM chapitres JOIN oeuvre ON oeuvre.id=chapitres.idOeuvre WHERE nom='$nom' ORDER BY numChap DESC LIMIT 1";
                                $resLastChap = mysqli_query($mysqli, $queryLastChapter);
                                $resultLastChap = mysqli_fetch_assoc($resLastChap);
                            ?>
                            <h2>Chapitre <?php echo $resultLastChap['numChap']; ?></h2>
                        </div> <!--.last-chap-->
                    ...
                    <div class="chap-list">
                        ...
                        <div class="scroll">
                            ...
                            <?php 
                                $queryChap = "SELECT * FROM chapitres JOIN oeuvre ON oeuvre.id=chapitres.idOeuvre WHERE nom='$nom' ORDER BY numChap DESC";
