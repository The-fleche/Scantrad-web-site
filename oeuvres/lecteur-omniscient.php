...
<html lang="fr-fr">
    ...
    <body>
        ...
        <section class="top">
            ...
            <hr>
            <div class="nav">
            <li><a href="../test en cours/catalogue.html"><h2>Novel</h2></a></li>
            <li><a href="../test en cours/catalogue.html"><h2>Manga</h2></a></li>
            <li><a href="../test en cours/catalogue.html"><h2>Webtoon</h2></a></li>
        </div><!-- .nav -->
            <hr>
        </section> <!-- .top -->
...
<body>
    ...
    $query = "SELECT * FROM oeuvre WHERE nom='Lecteur Omniscient'";
